...
namespace przykladoweKolokwium.Migrations
{
    ...
    [Migration("20200619203304_Migration2")]
            ...
            modelBuilder.Entity("przykladoweKolokwium.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdEmployee = 1,
                            Notes = "Tort bezowy",
                            OrderDate = new DateTime(2020, 6, 19, 22, 33, 3, 631, DateTimeKind.Local).AddTicks(8068),
                            RealizationDate = new DateTime(2020, 6, 21, 22, 33, 3, 639, DateTimeKind.Local).AddTicks(5634)
                        });
                });

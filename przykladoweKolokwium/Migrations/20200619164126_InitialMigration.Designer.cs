...
namespace przykladoweKolokwium.Migrations
{
    ...
    [Migration("20200619164126_InitialMigration")]
            ...
            modelBuilder.Entity("przykladoweKolokwium.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdEmployee = 1,
                            Notes = "Tort bezowy",
                            OrderDate = new DateTime(2020, 6, 19, 18, 41, 25, 706, DateTimeKind.Local).AddTicks(6122),
                            RealizationDate = new DateTime(2020, 6, 21, 18, 41, 25, 711, DateTimeKind.Local).AddTicks(351)
                        });
                });
